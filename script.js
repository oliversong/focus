var restricted = ['www.facebook.com','www.google.com/reader/view/','www.twitter.com',
...
function blockDat(){
	...
	var mytext=document.createTextNode('NOPE');
	message.appendChild(mytext);
	message.setAttribute('style',"width:50%;top:25%;left:25%;border-radius:3px;z-index:9999;position:fixed;background-color:#CCC;opacity:1;text-align:center;font-size:90px;font-family:Helvetica;height:100px;padding-top:60px;padding-bottom:50px;line-height:90px !important;");
