...
if(
  restricted.indexOf(currentURL) != -1 ||
  restricted.indexOf(currentURL+urlpath) != -1
){
	blockDat();
}
...
function blockDat(){
	...
	message.setAttribute('style',"width:50%;top:25%;left:25%;border-radius:3px;z-index:9999;position:fixed;background-color:#DDD;opacity:1;text-align:center;font-size:90px;font-family:Helvetica;height:100px;padding-top:60px;padding-bottom:50px;line-height:90px !important;color:#333 !important;box-sizing:content-box !important;");
